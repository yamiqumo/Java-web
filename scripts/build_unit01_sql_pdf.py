...
def main() -> int:
	...
	pdf_html = root / "Unit01_SQL" / "Html-01 SQL基礎（SELECT-INSERT）-pdf.html"
	doc = f"""<!DOCTYPE html>
<html lang="ja">
<head>
<meta charset="utf-8">
...
"""
	...
	if chrome is None:
		print("CHROME_NOT_FOUND: PDFは手動で「Html-01 SQL基礎（SELECT-INSERT）-pdf.html」を開き印刷してください。", file=sys.stderr)
		return 0
